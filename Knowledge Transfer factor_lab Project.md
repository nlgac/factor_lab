...
> 
> **Here is the current codebase as a single installer script.** Please analyze this code to understand the current architecture, types, and logic. Once you have analyzed it, confirm you are ready to continue development.
> 
> Python
> 
> ```
> # [PASTE CONTENT OF install_factor_lab.py HERE]
> ```
...
> **Here is the documentation generator for context on the API:**
> 
> Python
> 
> ```
> # [PASTE CONTENT OF install_factor_lab_docs.py HERE]
> ```
